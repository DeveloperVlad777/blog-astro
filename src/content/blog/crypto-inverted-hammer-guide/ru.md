...
intro:
  - "Для трейдеров свечи — это не просто фигуры на графике, а ранние сигналы возможных изменений настроений на рынке. Один из самых любопытных паттернов называется обратный молот. Он выглядит почти перевёрнутым, будто график играет с вами шутки. Так зачем вообще изучать этот паттерн? Потому что если вы торгуете криптой, форексом или акциями, вы будете видеть этот паттерн раз за разом в течение дня."
